...
minimize Displacement: (x1*(x2 + 3) - ((-11/4)*v11 + (0)*v12 + (7*x2-2)*v13 + (-3*x2-8.5)*v14)) + (x1*x1*x2 - ((-13/6)*v21 + (0)*v22 + (-2*x1-8.5)*v23 + (-2*x1-2)*v24));
...
subject to C_1: (1)*v11 + (-1)*v12 + (2)*v13 + (2)*v14 = x2 +3;
subject to C_2: (1)*v21 + (-1)*v22 + (3)*v23 + (-7)*v24 = x1*x1;

subject to C1: -11/4 <= x1 <= 0;
subject to C2: -13/6 <= x2 <= 0;
subject to C3: 2*x1 + 3*x2 + 8.5 >=0;
subject to C4: 7*x2 <= 2*x1 + 2;
